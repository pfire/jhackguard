 ...
 */
class JhackguardViewOutputfilters extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JhackguardHelper::addSubmenu('outputfilters');
	...
	protected function getSortFields()
	{
		...
		'a.created_by' => JText::_('COM_JHACKGUARD_OUTPUTFILTERS_CREATED_BY'),
		'a.name' => JText::_('COM_JHACKGUARD_OUTPUTFILTERS_NAME'),
		);
	}
