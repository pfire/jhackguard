 ...
 */
class JhackguardViewBotscoutrecords extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JhackguardHelper::addSubmenu('botscoutrecords');
	...
	protected function getSortFields()
	{
		...
		'a.ip_address' => JText::_('COM_JHACKGUARD_BOTSCOUTRECORDS_IP_ADDRESS'),
		'a.result' => JText::_('COM_JHACKGUARD_BOTSCOUTRECORDS_RESULT'),
		'a.expires' => JText::_('COM_JHACKGUARD_BOTSCOUTRECORDS_EXPIRES'),
		);
	}
