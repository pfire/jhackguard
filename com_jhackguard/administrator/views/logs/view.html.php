 ...
 */
class JhackguardViewLogs extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JhackguardHelper::addSubmenu('logs');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JHACKGUARD_TITLE_LOGS'), 'logs.png');
        ...
        if (file_exists($formPath)) {
            ...
            if ($canDo->get('core.create')) {
			    //We would like not to be able to create new logs :)
		...
		JHtmlSidebar::setAction('index.php?option=com_jhackguard&view=logs');
